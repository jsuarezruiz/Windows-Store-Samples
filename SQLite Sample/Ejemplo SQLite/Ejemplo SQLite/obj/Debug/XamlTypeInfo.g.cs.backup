...
using Ejemplo_SQLite.Ejemplo_SQLite_XamlTypeInfo;
...
namespace Ejemplo_SQLite.Ejemplo_SQLite_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_0_MainPage() { return new Ejemplo_SQLite.MainPage(); }
        ...
        private IXamlType CreateXamlType(string typeName)
        {
            ...
            case "Ejemplo_SQLite.MainPage":
                userType = new XamlUserType(this, typeName, typeof(Ejemplo_SQLite.MainPage), GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"));
