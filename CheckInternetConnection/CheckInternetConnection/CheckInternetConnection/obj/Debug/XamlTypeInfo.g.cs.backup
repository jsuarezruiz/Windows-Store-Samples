...
using CheckInternetConnection.CheckInternetConnection_XamlTypeInfo;
...
namespace CheckInternetConnection.CheckInternetConnection_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_0_MainPage() { return new CheckInternetConnection.MainPage(); }
        ...
        private IXamlType CreateXamlType(string typeName)
        {
            ...
            case "CheckInternetConnection.MainPage":
                userType = new XamlUserType(this, typeName, typeof(CheckInternetConnection.MainPage), GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"));
